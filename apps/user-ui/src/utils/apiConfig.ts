// Centralized API configuration for consistent patterns
...
export const API_CONFIG = {
  ...
  STALE_TIME: {
    ...
    PRODUCT_LIST: 5 * 60 * 1000,  // 5 minutes - product listings
    PRODUCT_DETAIL: 10 * 60 * 1000, // 10 minutes - product details
    USER: 10 * 60 * 1000,         // 10 minutes - user data
    ORDER: 2 * 60 * 1000,         // 2 minutes - order data (more dynamic)
