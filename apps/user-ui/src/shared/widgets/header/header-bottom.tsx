    ...
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative flex items-center justify-between ${isSticky ? 'py-3' : 'py-0'}`}>
        ...
        <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50 transition cursor-pointer">
                ...
                <Link href="/login" className="text-sm text-blue-600 hover:text-blue-800 font-medium transition underline">
                    Sign in
                </Link>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2">
                ...
                <Heart size={20} />
                <span className="absolute -top-1 -right-1 bg-red-600 text-white text-[10px] font-bold rounded-full px-1.5 leading-[14px]">0</span>
                </button>
