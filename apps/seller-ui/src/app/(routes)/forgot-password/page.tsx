...
const ForgotPassword = () => {
  ...
  return (
    <div className="w-full py-10 min-h-[80vh] bg-gradient-to-br from-purple-50 to-blue-50">
      <h1 className="text-4xl font-semibold text-gray-800 text-center">
        Forgot Password
      </h1>
      <p className="text-center text-lg font-medium py-3 text-gray-500">
        Seller Portal . Forgot Password
      </p>

      <div className="w-full flex justify-center">
        <div className="md:w-[480px] p-8 bg-white shadow-lg rounded-2xl border border-gray-100">
          {step === "email" && (
            <>
              ...
              >
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-100 transition"
                  autoComplete="email"
                  {...registerEmail("email", {
                ...
                <button
                  ...
                  className="w-full p-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold text-lg rounded-lg hover:from-purple-700 hover:to-blue-700 transition mt-5 disabled:opacity-60"
                >
          ...
          {step === "otp" && (
            <>
              ...
              <div className="flex justify-center gap-3 mb-6">
                {otp.map((digit, index) => (
                  <input
                    ...
                    type="text"
                    maxLength={1}
                    className="w-14 h-14 border-2 border-gray-300 text-center text-xl font-bold outline-none rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-100 transition"
                    ref={(el) => {
              ...
              <div className="flex flex-col gap-3">
                <button
                  type="button"
                  className="w-full text-lg cursor-pointer bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition"
              ...
              {serverError && (
                <p className="text-red-500 text-sm mt-3 text-center">{serverError}</p>
              )}
            </>
          )}
            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className="w-full mt-5 text-lg cursor-pointer bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg font-semibold disabled:opacity-60 transition"
                >
