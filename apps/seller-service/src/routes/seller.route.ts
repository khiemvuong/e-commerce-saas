...
import { getOrderDetails, getSellerAnalytics, getSellerOrders, getShopById, getShopDetails, updateDeliveryStatus, updateShop, uploadShopImage } from '../controller/seller.controller';
